...
public class CalorieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button = rootView.findViewById(R.id.generateResponse);
            ...
            public void onClick(View view) {
                ...
                call2.enqueue(new Callback<Nutrition>() {
                    ...
                    public void onResponse(Call<Nutrition> call, Response<Nutrition> response) {
                        ...
                        fiberText.setText(nutri3);
                        carbsText.setText(nutri4);
                        sugarText.setText(nutri5);
                    }
